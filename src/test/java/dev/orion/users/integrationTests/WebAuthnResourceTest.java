...
public class WebAuthnResourceTest {
    ...
    private void testWebAuthn(String userName, User user, Endpoint endpoint) {
        ...
        if (endpoint == Endpoint.DEFAULT)
            ...
            invokeCustomEndpoint("api/users/webauthn/register", cookieFilter, request -> {
    ...
    private void invokeCustomEndpoint(String uri, Filter cookieFilter,
            Consumer<RequestSpecification> requestCustomiser) {
