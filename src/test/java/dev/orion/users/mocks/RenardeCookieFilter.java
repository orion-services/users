...
public class RenardeCookieFilter implements Filter {
    ...
    /**
     * Create an instance of {@link CookieFilter} that will prevent cookies with the
     * same name to be sent twice.
     *
    ...
    /**
     * Create an instance of {@link CookieFilter} that allows specifying whether or
     * not it should accept (and thus send)
     * multiple cookies with the same name.
     * Default is <code>false</code>.
     *
     * @param allowMultipleCookiesWithTheSameName Specify whether or not to allow
     *                                            found two cookies with same name
     *                                            eg.
    ...
    private boolean allowMultipleCookiesWithTheSameNameOrCookieNotPreviouslyDefined(
